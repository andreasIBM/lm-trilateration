...
var LM = {
    ...
    optimize: function(func,p,t,y_dat,weight,dp,p_min,p_max,c,opts){
        ...
        //my Stuff
        covar = math.inv(JtWJ);
        var diag_covar = math.diag(covar);
        var matrxx = new Matrix(diag_covar.length,1);
        for (i=0; i < diag_covar.length;i++) {
            matrxx[i][0]=diag_covar[i];
        }
        sigma_p = math.sqrt(matrxx);

        return { p:p, X2:X2, covar:covar, sigma_p:sigma_p};
    },
